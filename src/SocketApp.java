...
public class SocketApp {
    ...
    public static void main(String[] args) {
        ...
        // 
        // javac SocketApp.java <-- complile  at src\day04-workshop-task\src
        // all the class file will be complied at src folder
        ...
        try {
            ...
            while (true) {
                ...
                if (fromClient.equalsIgnoreCase("get-cookie")) {
                    ...
                    dos.writeUTF(new CookieFile().GetRandomCookieFromFile("cookie-file.txt"));
                    dos.flush();
                } else {
